...
namespace SignalChat.Core.Tasks
{
    ...
    public class ProtectPasswordService : IProtectPasswordService
    {
        ...
        {
            return PasswordStorage.CreateHash(plainTextPassword);
        }

        public bool VerifyPassword(string plainTextPassword, string saltedPassword)
        {
            return PasswordStorage.VerifyPassword(plainTextPassword, saltedPassword);
        }
